...
class UserServiceTest {
    ...
    private ChangePasswordRequest buildChangePasswordRequest(String oldPass, String newPass) {
    ...
    void updatePassword_ValidOldPassword_Success() {
        Long userId = 1L;
        ChangePasswordRequest request = TestDataHelper.buildChangePasswordRequest("oldPass", "newPass");
    ...
    void updatePassword_InvalidOldPassword_ThrowsException() {
        Long userId = 1L;
        ChangePasswordRequest request = TestDataHelper.buildChangePasswordRequest("wrongPass", "newPass");
